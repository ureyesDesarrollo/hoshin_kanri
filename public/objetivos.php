      ...
      <div class="col-6">
        <div class="d-flex align-items-center mb-4">
          ...
          <div class="d-flex align-items-center">
            ...
            <span class="ms-2 fw-bold">Objetivos</span>
          </div>
        </div>
      ...
      <div class="card-body">
        <div class="d-flex align-items-center justify-content-between">
          <div class="d-flex align-items-center flex-grow-1">
            ...
            <div>
              <h1 class="h3 fw-bold mb-1">Gestión de Objetivos</h1>
              <p class="text-muted mb-0">Administra y monitorea los objetivos estratégicos</p>
            </div>
          </div>
    ...
    <div class="row mb-4 fade-in-up">
      <div class="col-md-3 col-sm-6 mb-3">
        <div class="stats-card">
          ...
          <div class="stats-number" id="totalObjetivos">0</div>
          <div class="stats-label">Total Objetivos</div>
        </div>
      </div>
      <div class="col-md-3 col-sm-6 mb-3">
        <div class="stats-card">
          ...
          <div class="stats-number" id="activosCount">0</div>
      ...
      <div class="col-md-3 col-sm-6 mb-3">
        <div class="stats-card">
          ...
          <div class="stats-number" id="cerradosCount">0</div>
      ...
      <div class="card-body p-0">
        ...
        <div class="p-4">
          <div class="row g-2 mb-2">
            <div class="col-md-4">
              <input type="text" id="buscarTituloObjetivo" class="form-control" placeholder="Buscar por título...">
            </div>
            <div class="col-md-4">
              <input type="text" id="buscarResponsableObjetivo" class="form-control" placeholder="Buscar por responsable...">
            </div>
            <div class="col-md-2">
              <button class="btn btn-primary w-100" id="btnLimpiarBusquedaObjetivos">Limpiar</button>
            </div>
          </div>
        </div>
        <div class="table-responsive">
          <table class="table table-hover align-middle mb-0" id="tablaObjetivos">
              ...
              <tr id="loadingRow">
                <td colspan="5" class="text-center py-5">
                  <div class="d-flex flex-column align-items-center justify-content-center">
                    ...
                    <h6 class="text-muted mb-2">Cargando objetivos...</h6>
              ...
              <tr id="emptyRow" class="d-none">
                <td colspan="5" class="text-center py-5">
                  <div class="d-flex flex-column align-items-center justify-content-center">
                    ...
                    <h6 class="text-dark mb-2 fw-semibold">No hay objetivos creados</h6>
                    <p class="text-muted small mb-3">Comienza creando tu primer objetivo estratégico</p>
                    <button class="btn btn-primary d-flex align-items-center gap-2" id="btnNuevoObjetivoTabla">
                      <i class="fas fa-plus"></i>
        ...
        <div class="card-footer bg-white border-top-0 py-3 d-flex justify-content-between align-items-center">
          <div class="text-muted small">
            Mostrando <span class="fw-semibold" id="showingCount">0</span>
            de <span class="fw-semibold" id="totalCount">0</span> objetivos
          </div>

          <ul class="pagination pagination-sm mb-0" id="paginacionObjetivos"></ul>
    ...
    <div class="modal-content border-0" style="border-radius:16px">
      ...
      <div class="modal-header">
        <h5 class="modal-title">
          ...
          <span id="modalTitulo">Nuevo Objetivo</span>
        </h5>
      ...
      <div class="modal-body p-4">
        ...
        <div class="row">
          <div class="col-md-4 mb-3">
            ...
            <select id="objPeriodo" class="form-select">
              <option value="1" selected>2026</option>
            </select>
          </div>

          <div class="col-md-8 mb-3">
            <label class="form-label fw-semibold">Responsable <span class="text-danger">*</span></label>
            <select id="objRespId" class="form-select">
            </select>
          </div>
        </div>
