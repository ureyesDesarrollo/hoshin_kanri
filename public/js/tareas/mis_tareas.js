  ...
  <div class="col-lg-4 col-md-6 mb-4">
    <div class="task-card
      ...
      <div class="task-card__content">
        ...
        <div class="task-card__priority-section">
        <span class="priority-label">Prioridad</span>
        <span class="priority-badge priority-${t.prioridad}">
          ${getPrioridadTexto(t.prioridad)}
        </span>
      </div>
...
function loadMisTareas(page = 1) {
  ...
  setTimeout(() => {
    ...
    $.get(
      "/hoshin_kanri/app/tareas/mis_tareas_lista.php",
      { page, limit: 12, o, q, f },
      function (resp) {
        ...
        $("#totalMisTareasCount").text(
          resp.pagination?.total ?? resp.data.length,
        );
  ...
  Swal.fire({
    ...
    if (!resp || !resp.success) {
      Swal.fire({
        ...
        title: "Error",
        text:
          resp && resp.message ? resp.message : "No se pudo enviar a revisión",
      });
      return;
    }
