function loadEstrategiasStats(periodoId) {
    $.get('/hoshin_kanri/app/estrategias/stats.php', {
...
function loadEstrategias(page = 1) {
    ...
    $.get('/hoshin_kanri/app/estrategias/lista.php', {
        page: page
    }, function (resp) {

        const tbody = $('#tablaEstrategias tbody');
        tbody.find('tr:not(#loadingEstrategiasRow, #emptyEstrategiasRow)').remove();
...
$(document).ready(function () {
    ...
    $('#tablaEstrategias').on('click', '.btnEditarEstrategia', function () {
        ...
        $.get('/hoshin_kanri/app/estrategias/listar_por_id.php', { id }, function (resp) {
    ...
    $('#btnGuardarEstrategia').on('click', function () {
        ...
        if (estrategia_id) {
            $.ajax({
                ...
                data: { titulo, responsable_id, descripcion, prioridad, estrategia_id, objetivos },
