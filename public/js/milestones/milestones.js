function loadMilestonesStats() {
    $.get('/hoshin_kanri/app/milestone/stats.php', function (resp) {
...
function loadMilestones(page = 1) {
    ...
    $.get('/hoshin_kanri/app/milestone/lista.php', {
        page: page
    }, function (resp) {
...
function loadObjetivosModalMilestone(selected = []) {
    ...
    $.get('/hoshin_kanri/app/objetivos/listar.php', function (resp) {
...
function openEditMilestone(data) {
    var modalMilestone = new bootstrap.Modal(document.getElementById('modalMilestone'));
    ...
    $.get('/hoshin_kanri/app/estrategias/listar_por_id.php', {
...
$(document).ready(function () {
    ...
    $('#tablaMilestones').on('click', '.btnEditarMilestone', function () {
        ...
        $.get('/hoshin_kanri/app/milestone/listar_por_id.php', { id }, function (resp) {
            if (!resp.success) {
    ...
    $('#btnGuardarMilestone').on('click', function () {
        ...
        if (milestone_id) {
            $.ajax({
                ...
                data: {
                    titulo, descripcion, responsable_id, estrategia_id, milestone_id
                },
