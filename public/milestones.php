      ...
      <div class="card-body p-0">
        <div class="p-4">
          <div class="row g-2 mb-2">
            <div class="col-md-4">
              <input type="text" id="buscarMilestone" class="form-control" placeholder="Buscar por título...">
            </div>
            <div class="col-md-4">
              <input type="text" id="buscarResponsableMilestone" class="form-control" placeholder="Buscar por responsable...">
            </div>
            <div class="col-md-2">
              <button class="btn btn-primary w-100" id="btnLimpiarBusquedaMilestones">Limpiar</button>
            </div>
          </div>
        </div>
